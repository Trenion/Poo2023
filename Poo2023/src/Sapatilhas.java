public class Sapatilhas extends Artigos {
    ...
    public Sapatilhas(String Tipo, int Tamanho, boolean Atacadores, String Color,int Year, double PrecoBase, boolean Premium, boolean UsadoS) {
        this.Tipo = Tipo;
    ...
    public Sapatilhas(Sapatilhas A) {
        this.Tipo = A.getTipo();
